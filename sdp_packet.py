...
def build_sdp_service_attr_request(tid, service_record_handle, max_attr_byte_count, attribute_list):
    ...
    for attr_id in attribute_list:
        attr_struct = build_attr_id_struct(attr_id)
...
def parse_sdp_response(response):
    ...
    try:
        ...
        if pdu_id == 0x03:
            ...
            # Parse handle list
            handle_data = response[9:-1]  # Skip continuation state
